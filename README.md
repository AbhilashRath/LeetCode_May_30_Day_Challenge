...
**Algorithm**
This question is similar to longest common subsequence.

**Solution Link**: [Uncrossed Lines](https://github.com/AbhilashRath/LeetCode_May_30_Day_Challenge/blob/master/Uncrossed_Lines.java)
